...
class Main extends Component {
  ...
  calculate = (timeStart, timeEnd) => {
    ...
    const diff =
      timeInHour(timeStart) > timeInHour(timeEnd)
    ...
    return (
      <div className='Main'>
        <h1 className='Main-instructions'>
          Pour calculer les horaires du 2ème tiers, du dernier tiers et du milieu de la nuit, entrez
          les horaires de Maghrib et de Fajr.
        </h1>
        ...
        <div className='Times-container'>
          ...
          <div className={third2 && middle && third3 ? 'show' : 'hide'}>
            <Time label='2e tiers' time={third2} color='#d67474' />
            <Time label='Milieu' time={middle} color='#a376d2' />
            <Time label='3e tiers' time={third3} color='#6f89d9' />
          </div>
